        ...
        <div class="authentication-inner">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Silahkan melakukan login terlebih dahulu</p>
              <form id="formAuthentication" class="mb-3" action="/contact-app-manager/login" method="POST">
                <div class="mb-3">
              ...
              <p class="text-center">
                ...
                <a href="/contact-app-manager/register">
                  <span>Register</span>
                </a>
              </p>
            </div>
